...
{{%refer%}}
For a detailed description of the Geospatial queries refer to {{%exurl "Geospatial Queries""http://docs.gigaspaces.com/xap120/query-geospatial.html"%}} for more info.
{{%/refer%}}
